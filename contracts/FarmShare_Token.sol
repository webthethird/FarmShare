contract FarmShare_Token{
    ...
    function FarmShare_Token() {
        treasury = msg.sender;
        balances[treasury] = 100000000;
    ...
    function mintToken(address _creator, uint256 _mintedAmount) {
        if (msg.sender == treasury) {
            balances[_creator] += _mintedAmount;
            totalSupply += _mintedAmount;
            Transfer(0, _creator, _mintedAmount);
        }
    }
